# Road Traffic Accident Analysis in Egypt

This repository contains the graduation project proposal and subsequent analysis for the **Data Analysis** track at the **Next Career Development Academy**. The project focuses on leveraging data analytics to improve road safety in Egypt.
...
4.  **Analysis:** Calculating Key Performance Indicators (KPIs) and performing aggregations.
5.  **Reporting:** Visualizing findings through Power BI dashboards.
...
* Provision of actionable insights for awareness and infrastructure planning.
...
* **Islam Ahmed Ibrahim**
* **Abdelrahman Talaat Abdelrahman**
* **Malak Magdy Mohamed**
* **Salma Ahmed Fath Elbab**
* **Retaj Tareq Rajab**
